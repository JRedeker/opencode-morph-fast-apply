---
name: morph
description: "Morph fast-apply edit guidance — use when editing large files (300+ lines), multi-hunk changes, or complex refactoring. Covers marker syntax, disambiguation, and when to prefer morph_edit vs native edit."
license: MIT
metadata:
  priority: high
  replaces: none
...
Load this skill when you need to **edit files using `morph_edit`** — especially large files, multi-hunk edits, or complex refactoring. If you're making a simple single-line replacement, use native `edit` instead and skip this skill.
...
## Keywords
morph, morph_edit, fast apply, file editing, large file edit, multi-hunk edit,
partial code snippets, existing code markers, complex refactoring, edit vs morph,
code merge, disambiguation, whitespace-sensitive
